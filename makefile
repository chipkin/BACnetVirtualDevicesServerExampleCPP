...
CC := g++
NAME := BACnetVirtualDevicesServerExampleCPP_linux_x64_Release
...
SOURCES = $(wildcard build/BACnetVirtualDevicesServerExampleCPP/*.cpp) $(wildcard submodules/cas-bacnet-stack/adapters/cpp/*.cpp)  $(wildcard submodules/cas-bacnet-stack/submodules/cas-common/source/*.cpp) 
...
obj/%.o: build/BACnetVirtualDevicesServerExampleCPP/%.cpp
	@mkdir -p obj
	@echo 'Building file: $<'
